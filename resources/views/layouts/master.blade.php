...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <head>
    ...
    <meta name="description" content="GurujiNow">
    <meta name="keywords" content="GurujiNow">
    <meta name="csrf-token" content="{{ csrf_token() }}"> 
    <title>@yield('title')</title>
    <link rel="apple-touch-icon" href="{{ asset('app-assets/images/favicon/guru_ji_logo-01.png') }}">
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('app-assets/images/favicon/guru_ji_logo-01.png') }}">
        ...
        <nav class="navbar-main navbar-color nav-collapsible sideNav-lock navbar-dark gradient-45deg-indigo-purple no-shadow">
          <div class="nav-wrapper">
            ...
            <ul class="navbar-list right">
              ...
              <li><a class="waves-effect waves-block waves-light profile-button" href="javascript:void(0);" data-target="profile-dropdown"><span class="avatar-status avatar-online"><img src="@if(!empty(Auth::user()->thumbnail)){{ Auth::user()->thumbnail}} @else {{ asset('app-assets/images/avatar/avatar-7.png') }} @endif" alt="avatar"><i></i></span></a></li>
...
> -->
    ...
    <footer class="page-footer footer footer-static footer-dark gradient-45deg-indigo-purple gradient-shadow navbar-border navbar-shadow">
      <div class="footer-copyright">
        <div class="container"><span>&copy; 2021          <a href="{{ url('/admin') }}" target="_blank">BWT</a> All rights reserved.</span><span class="right hide-on-small-only">Design and Developed by <a href="{{ url('/admin') }}">BWT</a></span></div>
      </div>
    </footer>
