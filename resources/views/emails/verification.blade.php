        ...
        <tr>
            <td>
                <table style="background-color: #f2f3f8; max-width:670px; margin:0 auto;" width="100%" border="0"
                            ...
                            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        ...
                                        To activate your account, please follow the link below. If you cannot click the link, please copy the entire link, and paste it into your browser.
                                        If you do not click the link provided, your account will not be activated. You can also cancel at any time.
                                        <a href="{{ url('email/confirmation/'.base64_encode($data['email'])).'?b='.$data['reviewing'] }}"> {{ url('email/confirmation/'.base64_encode($data['email'])) }} </a>
                                    </p>

                                   
                                    <p style="font-size:15px; color:#455056; margin:8px 0 0; line-height:24px;">   Thank you! </p>
                                    
                                    <p style="font-size:15px; color:#455056; margin:8px 0 0; line-height:24px;">   Busking with Talent®        
                                    </p>
                                        <span
                    ...
                    <tr>
                        <td style="text-align:center;">
                            <p style="font-size:14px; color:rgba(69, 80, 86, 0.7411764705882353); line-height:18px; margin:0 0 0;">&copy; <strong>BWT</strong> </p>
                        </td>
                    </tr>
                    <tr>
                        <td style="height:80px;">&nbsp;</td>
