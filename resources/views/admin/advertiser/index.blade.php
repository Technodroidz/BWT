...
@section('title') Admin | Advertiser @endsection
            ...
            <tbody>
              ...
              <tr>
                <td>{{ $key+1 }}</td>
                  ...
                  <td>                    
                    <a href="{{ route('admin.advertiser.edit',$row->id)}}">
                        <i class="far fa-pencil"></i>
                    </a>
                    <a href="{{url('/admin/advertiser/delete/'.$row->id) }}" onclick="return confirm('Are you sure to delete this item?')">
