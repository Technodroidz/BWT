...
<div class="breadcrumb-header justify-content-between">
  <div class="left-content">
    <div>
      <h4 class="main-content-title tx-22 mg-b-1 mg-b-lg-1">Partner List</h4>
    ...
    <div class="card">
      <div class="card-body">
        <div class="table-responsive userlist-table">
          ...
          <form class="form-horizontal"  method="post" action="{{ route('admin.partner.update',$partners->id) }}" enctype="multipart/form-data">
            @csrf
            <div class="row m-0">
