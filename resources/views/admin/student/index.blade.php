...
@section('title') Admin | Students @endsection
...
<div class="breadcrumb-header justify-content-between">
  <div class="left-content">
    <div>
      <h4 class="main-content-title tx-22 mg-b-1 mg-b-lg-1">Student</h4>
...
<div class="sidebar sidebar-right sidebar-animate">
  <div class="panel panel-primary card mb-0 box-shadow">
    ...
    <div class="panel-body tabs-menu-body latest-tasks border-0">
        ...
        <form class="form-horizontal" action="{{url('admin/student')}}">
              <div class="form-group">
                <input type="text" name="name" value="{{request('name')}}" class="form-control" placeholder=" Student Name">
              </div>
              <div class="form-group">
                <input type="text" name="position" value="{{request('position')}}" class="form-control" placeholder="Student position">
              </div>
              <div class="form-group mb-0 mt-3 justify-content-end">
                <div>
                  <button type="submit" class="btn btn-primary">Submit</button>
                  <a href={{url('admin/student')}} class="btn btn-secondary float-right">Reset</a>
                </div>
              </div>
            </form>
    </div>
