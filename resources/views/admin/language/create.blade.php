...
@section('title') Admin | Language | Create @endsection
    ...
    <div class="card">
      <div class="card-body">
        <div class="table-responsive userlist-table">
          ...
          <form class="form-horizontal"  method="post"  id="add__form" action="{{ route('admin.language.store') }}">
            @csrf
            <div class="row m-0">

            <div class="form-group col-sm-12">
              <label for="name">Name</label>
              <input type="text" class="form-control" id="name" value="{{old('name')}}" name="name" placeholder="Language Name here..">
            @error('name')
