          ...
          <table class="table card-table table-striped table-vcenter text-nowrap mb-0">
            <thead>
              <tr>
                ...
                <th class="wd-lg-10p"><span>Banner</span></th>
            ...
            <tbody>
              ...
              <tr>
                  ...
                  <td>
                       <img alt="Banner" class="rounded-circle avatar-md mr-2" src="{{ url('uploads/events/'.$row->image) }}"> 
                  </td>
                  <td>{{ $row->name ?? '-'  }}</td>
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                  ...
                  <a class="dropdown-item" href="{{ url('/admin/events/participated/'.$row->id) }}" onclick="return confirm('Are you sure?')">participated</a>
