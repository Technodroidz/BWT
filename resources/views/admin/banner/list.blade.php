...
@section('title') Admin | Banner @endsection
...
<div class="breadcrumb-header justify-content-between">
  <div class="left-content">
    <div>
      <h4 class="main-content-title tx-22 mg-b-1 mg-b-lg-1">Banner List</h4>
          ...
          <table class="table card-table table-striped table-vcenter text-nowrap mb-0">
            <thead>
              <tr>
                ...
                <th class="wd-lg-20p"><span>Banner</span></th>
            ...
            @endphp 
              ...
              <tr>
                ...
                <td>
                  ...
                  <td>
                    <label for="{{ $row->id }}"> 
                      <input id="{{ $row->id }}" data-url="{{ route('admin.banner.changestatus')}}" name="onoffswitch" type="checkbox" data-id="{{ $row->id }}" {{ $checked }} value="{{ $row->active }}">
                  ...
                  <td>                    
                      ...
                      <a href="{{ url('/admin/banner/delete/'.$row->id) }}" onclick="return confirm('Are you sure to delete this item?')">
...
<div class="sidebar sidebar-right sidebar-animate">
  <div class="panel panel-primary card mb-0 box-shadow">
    ...
    <div class="panel-body tabs-menu-body latest-tasks border-0">
        ...
        <form class="form-horizontal" action="{{url('admin/banner')}}">
              <div class="form-group">
                <input type="text" name="title" value="{{request('title')}}" class="form-control" placeholder=" Banner Title">
              </div>
              <div class="form-group mb-0 mt-3 justify-content-end">
                <div>
                  
                  <button type="submit" class="btn btn-primary">Submit</button>
                  <a href={{url('admin/banner')}} class="btn btn-secondary float-right">Reset</a>
                </div>
              </div>
            </form>
    </div>
