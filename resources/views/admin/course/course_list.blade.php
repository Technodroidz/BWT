...
@section('title') Admin | Course @endsection
      ...
      <div class="container">
        <div class="row">
          <div class="col s10 m6 l6">
            <h5 class="breadcrumbs-title mt-0 mb-0"><span>Course List</span></h5>
          ...
          <div class="col s2 m6 l6"><a class="btn waves-effect waves-light breadcrumbs-btn right" href="{{ route('admin.course.create')}}" id="add_edit_button"><i class="material-icons hide-on-med-and-up">settings</i><span class="hide-on-small-onl">Add New</span>
              ...
              <div class="responsive-table">
                <table id="state_list" class="table">
                  ...
                  <tbody>
                    ...
                    <td>
                      <a href="{{ route('admin.course.edit',$row->id)}}"><i class="material-icons">edit</i></a><a href="{{ url('/admin/course/delete/'.$row->id) }}" onclick="return confirm('Are you sure to delete this item?')"><i class="material-icons dp48">delete_forever</i></a>
                    </td>
