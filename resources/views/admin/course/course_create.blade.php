...
@section('title') Admin | Course | Create @endsection
          ...
          <div class="seaction">
            ...
            <div class="card">
              <div class="card-content">
                <p class="caption mb-0">Add new state</p>
              ...
              <div class="col s12 m12 l12 l6">
                <div id="placeholder" class="card card card-default scrollspy">
                  <div class="card-content">
                    ...
                    <form method="post" id="add_state_form" action="{{ route('admin.course.store') }}">
                      @csrf
                      <div class="row">
                        <div class="input-field col s12">
                          <input placeholder="Course Name here..." id="hindi_name" name="hindi_name" type="text">
                          <label for="name2">Hindi Name</label>
                        </div>
                      </div>
                      <div class="row">
                        <div class="input-field col s12">
                          <input placeholder="English Name here..." id="english_name" name="english_name" type="text">
