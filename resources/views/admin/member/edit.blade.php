...
<div class="breadcrumb-header justify-content-between">
  <div class="left-content">
    <div>
      <h4 class="main-content-title tx-22 mg-b-1 mg-b-lg-1">{{ $member->type }}</h4>
        ...
        <div class="table-responsive userlist-table">
          ...
          <form class="form-horizontal"  method="post" action="{{route('admin.member.update',$member->id)}}" enctype="multipart/form-data">
            ...
            <div class="form-group col-sm-6">
              ...
              <input type="text" class="form-control" id="name" value="{{old('name')??$member->name}}" name="name" placeholder="Enter Member">
            @error('name')
            ...
            <div class="form-group col-sm-6">
              ...
              <input type="text" class="form-control"  id="position"  value="{{old('position')??$member->position}}" name="position" placeholder="Enter Position">
              @error('position')
              <span class="text-danger">{{$message}}</span>
            @enderror            
            </div>
            ...
            <div class="form-group col-sm-6">
              ...
              <input type="text" class="form-control"  id="facebook" value="{{old('social_links.facebook')??$member->social_links['facebook']??''}}" name="social_links[facebook]" placeholder="Facebook Url...">
            ...
            <div class="form-group col-sm-6">
              ...
              <input type="text" class="form-control"  id="twitter" value="{{old('social_links.twitter')??$member->social_links['twitter']??''}}" name="social_links[twitter]" placeholder="twitter Url...">
            ...
            <div class="form-group col-sm-6">
              ...
              <input type="text" class="form-control"  id="linkedin" value="{{old('social_links.linkedin')??$member->social_links['linkedin']??''}}" name="social_links[linkedin]" placeholder="linkedin Url...">
              @error('social_links.linkedin')
              <span class="text-danger">{{$message}}</span>
            @enderror 
            </div>
          
            <input type="hidden" class="form-control" value="{{ $member->type }}" name="type" >
            ...
            <div class="form-group col-sm-12">
              ...
              <textarea type="text" class="form-control"  id="decription" name="decription" placeholder="Enter Description">{{old('decription')??$member->decription}}</textarea>
              @error('decription')
              <span class="text-danger">{{$message}}</span>
            @enderror 
            </div>
