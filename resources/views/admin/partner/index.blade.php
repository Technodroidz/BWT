...
@section('title') Admin | partners @endsection
...
<div class="breadcrumb-header justify-content-between">
  <div class="left-content">
    <div>
      <h4 class="main-content-title tx-22 mg-b-1 mg-b-lg-1">partners</h4>
  ...
  <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 grid-margin">
    ...
    @foreach($employees as $k=>$data)
        <tr>
            ...
            <td>
              <!-- <a href="#">Review</a> -->
              <a href="{{ url('admin/partner/reviewing/'.$data['user_id']) }}">Review</a>
              <a href="{{ url('admin/partner/delete/'.base64_encode($data['user_id'])) }}" onclick="return confirm('Are you sure to delete this item?')">
...
<div class="sidebar sidebar-right sidebar-animate">
  <div class="panel panel-primary card mb-0 box-shadow">
    ...
    <div class="panel-body tabs-menu-body latest-tasks border-0">
        ...
        <form class="form-horizontal" action="{{url('admin/partner')}}">
              ...
              <div class="form-group mb-0 mt-3 justify-content-end">
                <div>
                  ...
                  <a href={{url('admin/partner')}} class="btn btn-secondary float-right">Reset</a>
                </div>
              </div>
            </form>
    </div>
