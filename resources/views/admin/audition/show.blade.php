...
@section('title') Admin | Audition | Show  @endsection
                    ...
                    <div class="pl-0">
                        <div class="main-profile-overview">
                            <div class="main-img-user profile-user">
                                <img alt="" src="../assets/img/faces/16.jpg" src="{{$audition->photo}}" >
                            </div>
                            <div class="d-flex justify-content-between mg-b-10">
                                <div>
                                    <h5 class="main-profile-name">{{$audition->name}}</h5>

                                </div>
                            </div>

                            <div class="main-profile-bio">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
        ...
        <div class="col-lg-8">
                        ...
                        <div class="card-body">
                            <div class="counter-status d-flex md-mb-0">
                                ...
                                <div class="ml-auto">
                                    ...
                                    <h2 class="mb-0 tx-22 mb-1 mt-1">1,782</h2>
                                    <p class="text-muted mb-0 tx-11"><i class="si si-arrow-up-circle text-success mr-1"></i>increase</p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="tabs-menu ">
                        ...
                        <ul class="nav nav-tabs profile navtab-custom panel-tabs">
                            ...
                            <li class="">
                                <a href="#profile" data-toggle="tab" aria-expanded="false"> <span class="visible-xs"></span> <span class="hidden-xs">Information</span> </a>
                            </li>
                            <li class="">
                ...
                <div class="list-group">
                    ...
                    <div class="list-group-item">
                        <p>Email</p><span>{{$audition->Email}}</span>
                    </div>
...
<span class="tag tag-green">Free Style</span>
                ...
                <div class="list-group">
                    <div class="list-group-item border-top-0">
                        <p>Competition</p><span>Weekly Busker's Performance Comptetion</span>
                    </div>
                    <div class="list-group-item">
                        <p>Name</p><span>{{$audition->name}}</span>
                    </div>

                    <div class="list-group-item">
                        <p>Date of Birth</p><span>08/25/1980</span>
                    </div>
                    <div class="list-group-item">
                        <p>Age</p><span>{{$audition->age}}</span>
                    </div>
                    <div class="list-group-item">
                        <p>Street Address</p><span>{{$audition->StreetAddress}}</span>
                    </div>
                    <div class="list-group-item">
                        <p>Town/City</p><span>{{$audition->TownCity}}</span>
                    </div>
                    <div class="list-group-item">
                        <p>State</p><span>{{$audition->state}}</span>
                    </div>
                    <div class="list-group-item">
                        <p>Zip Code</p><span>{{$audition->ZipCode}}</span>
                    </div>
                    <div class="list-group-item">
                        <p>Country</p><span>{{$audition->country}}</span>
                    </div>
                    ...
                    <div class="list-group-item">
                        <p>Cell Phone</p><span>{{$audition->CellPhone}}</span>
                    </div>
                    <div class="list-group-item">
                        <p>Home Phone</p><span>{{$audition->HomePhone}}</span>
                    </div>
                    ...
                    <ul class="timeline-1 mb-0">
                        <li class="mt-0"> <i class="ti-pie-chart bg-primary-gradient text-white product-icon"></i> <span class="font-weight-semibold mb-4 tx-14 ">Do you perform solo or as part of a group? </span>
                            <p class="mb-0 text-muted tx-12">Group</p>
                        </li>
                        <li class="mt-0"> <i class="ti-pie-chart bg-danger-gradient text-white product-icon"></i> <span class="font-weight-semibold mb-4 tx-14 ">How many group members?</span>
                            <p class="mb-0 text-muted tx-12">15</p>
                        </li>
                        <li class="mt-0"> <i class="ti-pie-chart bg-success-gradient text-white product-icon"></i> <span class="font-weight-semibold mb-4 tx-14 ">What is the Group's name?</span>
                            <p class="mb-0 text-muted tx-12">Dancers</p>
                        </li>
                        ...
                        <li class="mt-0"> <i class="ti-pie-chart icons bg-primary-gradient text-white product-icon"></i> <span class="font-weight-semibold mb-4 tx-14 ">How many Years have you been busking?</span>
                            <p class="mb-0 text-muted tx-12">2</p>
                            ...
                            <p class="mb-0 text-muted tx-12">Florida</p>
                        </li>
                    ...
                    <div class="card">
                        <div class="card-body h-100">
                            <div class="pro-img-box">
                                ...
                                <img class="w-100" src="../assets/img/faces/16.jpg" alt="product-image">
