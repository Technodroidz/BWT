...
@section('title') Admin | UserCategory | Edit @endsection
    ...
    <div class="card">
      <div class="card-body">
        <div class="table-responsive userlist-table">
          ...
          <form method="post" id="add_state_form" action="{{ route('admin.usercategory.update',$usercategory->id) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group col-sm-12">
              ...
              <input type="text" class="form-control" id="name" value="{{ $usercategory->name }}" name="name" onkeyup="convertToSlug(this.value)" placeholder="Enter Name">
            ...
            <div class="col-sm-12">
              <div class="input-field col s12"> 
                ...
                <select name="parent_id" id="parent_id" class="form-control" >
                 ...
                 <option value="1" labelVal="0"  @if($usercategory->parent_id ==1) {{ 'selected' }} @endif >Main Category</option>
                 @if(!empty($listData))
