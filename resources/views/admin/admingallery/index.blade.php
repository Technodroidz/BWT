...
@section('title') Admin | AdminGallery @endsection
...
<div class="breadcrumb-header justify-content-between">
  <div class="left-content">
    <div>
      <h4 class="main-content-title tx-22 mg-b-1 mg-b-lg-1">AdminGallery</h4>
          ...
          <table class="table card-table table-striped table-vcenter text-nowrap mb-0">
            <thead>
              <tr>
                ...
                <th class="wd-lg-20p"><span>Position Name</span></th>
                <th class="wd-lg-20p">Action</th>
              </tr>
            </thead>
            <tbody>
              @if(!empty($admingalleries))
              @foreach($admingalleries as $key => $row )              
              <tr>
                <td>{{ $key+1 }}</td>
                  ...
                  <td>                    
                      ...
                      <a href="{{ route('admin.gallery.delete',$row->id) }}" onclick="return confirm('Are you sure to delete this item?')">
