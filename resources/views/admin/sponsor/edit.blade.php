...
<div class="breadcrumb-header justify-content-between">
  <div class="left-content">
    <div>
      <h4 class="main-content-title tx-22 mg-b-1 mg-b-lg-1">Sponsors List</h4>
    ...
    <div class="card">
      <div class="card-body">
        <div class="table-responsive userlist-table">
          ...
          <form class="form-horizontal"  method="post" action="{{ route('admin.sponsor.update',$sponsors->id) }}" enctype="multipart/form-data">
            @csrf
            <div class="row m-0">
            ...
            <div class="form-group col-sm-12">
              ...
              <input type="file" class="form-control"  id="image" accept=".jpg,.png,.jpeg,.gif"  name="image">
              @error('image')
