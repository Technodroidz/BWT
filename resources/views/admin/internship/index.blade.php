  ...
  <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 grid-margin">
    ...
    @foreach($internships as $k=>$data)
        <tr>
            ...
            <td>
              <!-- <a href="#">Review</a> -->
              <a href="{{ url('admin/internship/reviewing/'.$data['user_id']) }}">Review</a>
              <a href="{{ url('admin/internship/delete/'.base64_encode($data['user_id'])) }}" onclick="return confirm('Are you sure to delete this item?')">
