...
@section('title') Admin | City | Create @endsection
        ...
        <div class="seaction">
          ...
          <div class="card">
            <div class="card-content">
              <p class="caption mb-0">Add new city</p>
            ...
            <div class="col s12 m12 l12 l6">
              <div id="placeholder" class="card card card-default scrollspy">
                <div class="card-content">
                  ...
                  <form method="post" id="add_state_form" action="{{ route('admin.city.store') }}">
                    @csrf
                    <div class="row">
                      <div class="input-field col s12">   
                        <select name="state_id" id="state_id" class="select2 browser-default">
                          ...
                          @if(!empty($listData))
                            ...
                            <option value="{{ $row->id }}">{{ $row->english_name }} - {{ $row->hindi_name }}</option>
                            @endforeach
                          @endif 
                        </select>
