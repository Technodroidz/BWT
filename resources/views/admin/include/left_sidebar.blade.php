  <!-- BEGIN: SideNav-->
    <aside class="sidenav-main nav-expanded nav-lock nav-collapsible sidenav-light sidenav-active-square">
      <div class="brand-sidebar">
        <h1 class="logo-wrapper"><a class="brand-logo darken-1" href="{{ url('/admin/dashboard') }}"><img class="hide-on-med-and-down" src="{{ asset('app-assets/images/favicon/guru_ji_logo-01.png') }} " alt="guruji logo"/><img class="show-on-medium-and-down hide-on-med-and-up" src="{{ asset('app-assets/images/favicon/guru_ji_logo-01.png') }}" alt="guruji logo"/><span class="logo-text hide-on-med-and-down">{{ Auth::user()->name }}</span></a><a class="navbar-toggler" href="#"><i class="material-icons">radio_button_checked</i></a></h1>
      </div>
      <ul class="sidenav sidenav-collapsible leftside-navigation collapsible sidenav-fixed menu-shadow" id="slide-out" data-menu="menu-navigation" data-collapsible="menu-accordion">
        ...
        <li class="navigation-header"><a class="navigation-header-text">User Section</a><i class="navigation-header-icon material-icons">more_horiz</i>
        </li>
       ...
       <!--  <li class="bold"><a class="waves-effect waves-cyan " href="app-contacts.html"><i class="material-icons">import_contacts</i><span class="menu-title" data-i18n="Contacts">Contacts</span></a>
        ...
        <!-- <li class="bold"><a class="collapsible-header waves-effect waves-cyan " href="JavaScript:void(0)"><i class="material-icons">receipt</i><span class="menu-title" data-i18n="Invoice">Invoice</span></a>
          <div class="collapsible-body">
            ...
            <li class="bold"><a class="collapsible-header waves-effect waves-cyan " href="JavaScript:void(0)"><i class="material-icons">face</i><span class="menu-title" data-i18n="eCommerce">Users</span><span class="badge badge pill purple float-right mr-10">{{ App\User::count() }}</span></a>
            <div class="collapsible-body">
              <ul class="collapsible collapsible-sub" data-collapsible="accordion">
                <li><a href="{{ route('admin.getUserList') }}"><i class="material-icons">radio_button_unchecked</i><span data-i18n="Products Page">User List</span></a>
                </li>

                <li><a href="{{ route('admin.teacher.index') }}"><i class="material-icons">radio_button_unchecked</i><span data-i18n="Products Page">Teacher List</span></a>
                </li>
               <!--  <li><a href="{{ route('admin.course.index') }}"><i class="material-icons">radio_button_unchecked</i><span data-i18n="Pricing">Course(Class)</span></a>
                </li> -->
            </ul>
          </div>
        </li>
        <li class="navigation-header"><a class="navigation-header-text">Location </a><i class="navigation-header-icon material-icons">more_horiz</i>
        </li>
        <li class="bold"><a class="waves-effect waves-cyan " href="{{ route('admin.state.index') }}"><i class="material-icons dp48">add_location</i><span class="menu-title" data-i18n="User Profile">State List</span></a>
        <!-- <li class="bold"><a class="waves-effect waves-cyan " href="{{ route('admin.city.index') }}"><i class="material-icons dp48">add_location</i><span class="menu-title" data-i18n="User Profile">City</span></a>
        </li>  -->
        <li class="navigation-header"><a class="navigation-header-text">Others </a><i class="navigation-header-icon material-icons">more_horiz</i>
        </li>


        <li class="bold"><a class="waves-effect waves-cyan " href="{{ route('admin.cmspages') }}"><i class="material-icons">pages</i><span class="menu-title" data-i18n="User Profile">CMS pages</span></a>
        <li class="bold"><a class="waves-effect waves-cyan " href="{{ route('admin.videos') }}"><i class="material-icons">ondemand_video </i><span class="menu-title" data-i18n="User Profile"> Videos </span></a>
        <li class="bold"><a class="waves-effect waves-cyan " href="{{ route('admin.member.index') }}"><i class="material-icons">radio_button_unchecked </i><span class="menu-title" data-i18n="User Profile"> Member </span></a>

        <li class="bold"><a class="wave-effect  waves-cyan" href="{{ route('admin.events')}}"><i class="material-icons">event</i> <span class="menu-title" data-i18n="User Profile"></span>Events </a></li>

        <li class="bold"><a class="waves-effect waves-cyan " href="{{ route('admin.usercategory.index') }}"><i class="material-icons">crop_original</i><span class="menu-title" data-i18n="User Profile">User Category List</span></a>
        </li>
        <li class="bold"><a class="waves-effect waves-cyan " href="{{ route('admin.category.index') }}"><i class="material-icons">add_shopping_cart</i><span class="menu-title" data-i18n="User Profile">Category List</span></a>
        <li class="bold"><a class="waves-effect waves-cyan " href="{{ route('admin.product-category') }}"><i class="material-icons">add_shopping_cart</i><span class="menu-title" data-i18n="User Profile">Product Category</span></a>
        <li class="bold"><a class="waves-effect waves-cyan " href="{{ route('admin.language.index') }}"><i class="material-icons">format_list_bulleted</i><span class="menu-title" data-i18n="User Profile">Language List</span></a>
        </li>
        <li class="bold"><a class="waves-effect waves-cyan " href="{{ route('admin.banner.index') }}"><i class="material-icons">crop_original</i><span class="menu-title" data-i18n="User Profile">Banner List</span></a>
        </li>
      </li>
      <li class="bold"><a class="waves-effect waves-cyan " href="{{ route('admin.advertiser.index') }}"><i class="material-icons">radio_button_unchecked</i><span class="menu-title" data-i18n="User Profile">Advertiser List</span></a>
      </li>
    </li>
    <li class="bold"><a class="waves-effect waves-cyan " href="{{ route('admin.sponsor.index') }}"><i class="material-icons">radio_button_unchecked</i><span class="menu-title" data-i18n="User Profile">Sponsor List</span></a>
    </li>
  </li>
  <li class="bold"><a class="waves-effect waves-cyan " href="{{ route('admin.partner.index') }}"><i class="material-icons">radio_button_unchecked</i><span class="menu-title" data-i18n="User Profile">Partner List</span></a>
  </li>
  <li class="bold"><a class="waves-effect waves-cyan " href="{{ route('admin.contact.index') }}"><i class="material-icons">radio_button_unchecked</i><span class="menu-title" data-i18n="User Profile">Contact form list</span></a>
  </li>
  <li class="bold"><a class="waves-effect waves-cyan " href="{{ route('admin.feedback.index') }}"><i class="material-icons">radio_button_unchecked</i><span class="menu-title" data-i18n="User Profile">Feedback List</span></a>
  </li>
  <li class="bold"><a class="waves-effect waves-cyan " href="{{ route('admin.internship.index') }}"><i class="material-icons">radio_button_unchecked</i><span class="menu-title" data-i18n="User Profile">Internship List</span></a>
  </li>
  <li class="bold"><a class="waves-effect waves-cyan " href="{{ route('admin.student.index') }}"><i class="material-icons">radio_button_unchecked</i><span class="menu-title" data-i18n="User Profile">Student List</span></a>
  <li class="bold"><a class="waves-effect waves-cyan " href="{{ route('admin.gallery.index') }}"><i class="material-icons">radio_button_unchecked</i><span class="menu-title" data-i18n="User Profile">Gallery</span></a>
  </li>
       ...
       <!--  <li class="bold"><a class="collapsible-header waves-effect waves-cyan " href="JavaScript:void(0)"><i class="material-icons">photo_filter</i><span class="menu-title" data-i18n="Basic UI">Basic UI</span></a>
        ...
        <!-- <li class="bold"><a class="waves-effect waves-cyan " href="{{ route('admin.settings') }}" target="_blank"><i class="material-icons">settings</i><span class="menu-title" data-i18n="Setting">Settings</span></a> -->
        <li class="bold"><a class="waves-effect waves-cyan " href="JavaScript:void()" ><i class="material-icons">help_outline</i><span class="menu-title" data-i18n="Support">Support</span></a>
        </li>
      </ul>
