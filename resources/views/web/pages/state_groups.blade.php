    ...
    <br>
                        <div class="row ">
                           <div class="col-xl-12  text-center">
                              <div class="row ">
                                 <div class="col-xl-12  text-center">
                                    <!--<h5 class="bold-text h5-style font-style">STATE FOCUS CONTESTANTS’ JUDGES</h5>-->
                                    <!--<iframe id="player1" src="https://player.vimeo.com/video/76979871" width="100%" height="590" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>-->
