    ...
    <br>
                        <div class="row ">
                           <div class="col-xl-12  text-center">
                              <div class="row ">
                                 <div class="col-xl-12  text-center">
                                    <!--<h5 class="bold-text h5-style font-style">NATIONAL CONTESTANTS’ JUDGES</h5>-->
                                    <!--<iframe id="player1" src="{{asset('assets/img/WHO%20WE%20ARE.mp4')}}" poster="" width="100%" height="590" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>-->
                                    <video id="video1" controls style="width:100%;height:590px;" poster="{{asset('assets/img/image.png')}}">
                                  <source src="{{asset('assets\img\WHO WE ARE.mp4')}}" type="video/mp4">
