...
@section('title','Sponsorship Registration')
...
<div class="form-head" style="box-shadow:
    rgb(149 157 165 / 20%) 0px 8px 24px;">
                    ...
                    <h2>REGISTER AS SPONSOR OR ADVERTISER</h2>
                    @else
        ...
        <div class="card" id="card">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-sm-6" style="left: 18px;margin-top: 14px;margin-bottom: 16px;">
                            
  <input class="form-check-input" type="radio" value="Advertiser" name="type" checked="">
  <label for="a" style="font-weight: normal;">Advertiser *</label>

  <span style="margin-left: 45px;">
  <input class="form-check-input" type="radio" value="STATE &amp; NATIONAL COMPETITION" name="type" >
  <label for="a" style="font-weight: normal;">Sponsor </label>
          <span>                
              </div>
  @endif
   ...
   <input type="text" name="last_name"  value=""  class="form-control" placeholder="" required>
                ...
                <p class="text-danger">Email address is already registered with us !</p>            
                    ...
                    <div class="col-md-6 col-xs-12 form-group">
                        ...
                        <input type="text" name="business_name" class="form-control" placeholder="" required>
                    </div>

                    <div class="col-md-6 col-xs-12 form-group">
                        <label>What is the type of business? <sup style="color:#ff0000;">*</sup></label>
                        <input type="text" name="business_type" class="form-control" placeholder="" required>
                    </div>
                    @if(@$_GET['a'] == 1)
                ...
                <select class="form-control dropdown" id="education" name="state">
                ...
                <option value="WY">Wyoming</option>
                    ...
                    <div class="col-md-6 col-xs-12 form-group">
                        ...
                        <input type="password" name="password" class="form-control" placeholder="" required id="password-field">
...
<label style="color:#000;">Logo of yourself or company: </label>
...
<div class="col-md-4 col-xs-12 form-group">
    <label style="color:#000;">Commercial Video:</label>
...
<label><input type="checkbox" value="1" name="content_permission" >
    By submitting this Application Form, you agree to be bound by the
    <a class="create" href="{{ url('assets/upload/VIDEO-RELEASE CONSENT-FORM.pdf')