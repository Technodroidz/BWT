...
<div class="row ">
    ...
    <div class="col-md-12 text-right form-group">
        ...
        <div class="row">
            <div class="col-xl-6 posRel mar-0"> <a href="/sponsor/signup?a=1"> <button class="btn btn-success" style="float:left">  Register as a  sponsors </button> </a>
            </div>
...
<div class="wrap-height" style="width: 100%">
    ...
    <div class="row">
       <div class="col-xl-12 posRel mar-0">
          <!--<h4 class="slider_head">Sponsors</h4>-->
                            ...
                            <article class="material-card Pink">
                                  ...
                                  <div class="mc-content">
                                      <div class=" img-container" data-toggle="modal" data-target="#myProfile">
                                          <img class="img-responsive img-thumbnail" src="{{$sponsor->image_url}}" style="border-radius:0% !important;">
                                      </div>
