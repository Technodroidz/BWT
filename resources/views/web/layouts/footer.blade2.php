...
<footer id="footer">
    <div class="copyright text-center">
       <ul class="list-inline">
          ...
          <li class="list-inline-item" style="margin:5px 24px;"><a href="{{ url('contact')}}" style="color: #fff">Contact Us </a></li>
       </ul>
    </div>
 </footer>
    ...
    function renderInnerContent(innerProps) {
        ...
        return (createElement("div", { className: 'fc-event-main-frame' },
            ...
            createElement("div", { className: 'fc-event-title-container' },
                createElement("div", { className: 'fc-event-title fc-sticky',id:'amrit' }, innerProps.event.title || createElement(Fragment, null, "\u00A0")))));
    }
...
$(".addEventclick").on("click", function() {
    
     /*Start Add one day in date*/
     ...
     if(dd.toString().length){dd='0'+dd;}
     if(mm.toString().length){mm='0'+mm;}
     var someFormattedDate = y+'-'+mm + '-' + dd;
     /*End Add one day in date*/
...
/*function createChannel(){
    ...
    $("#preview_channel").html(`<div class="row ">
...
<div class="wrap-height" id="pad16"> 
    <div class="row ">
       <div class="col-xl-12">
          <div class="row">
             <div class="col-xl-12 col-xs-12">
                ...
                <br>
                <div class="">
                    <video id="video1" controls="" poster="http://creativedzine.co.in/bwt/public/assets/img/image.png">
                        <source src="http://creativedzine.co.in/bwt/public/assets/img/videoplayback.mp4" type="video/mp4">
      ...
      <!--       </div>-->
      <!--</div>-->
      <!--<a href="http://creativedzine.co.in/bwt/community-circle-message" class="link" id="mar16">Learn More</a>-->
      <!--       </div>-->
          </div>
          <div class="row bg4">
             <div class="col-xl-4 col-xs-12">
                 <a href="http://creativedzine.co.in/bwt/upload-performance">
                <br>
                <h4 class="slider_head pad0">Performances</h4>
                <span class="line-1 mr-l0"></span>
                <span class="line-2 mr-l0"></span>
                <br>
                <img class="bold-text box-shadow-style img-responsive" src="http://creativedzine.co.in/bwt/public/assets/img/gallery10.jpg" style="max-height:199px;min-height: 199px;"></a>
             </div>
             <div class="col-xl-4 col-xs-12">
                <a href="http://creativedzine.co.in/bwt/event">
                    <br>
                    <h4 class="slider_head pad0">Events</h4>
                    <span class="line-1 mr-l0"></span>
                    <span class="line-2 mr-l0"></span>
                    <br>
                    <img class="bold-text box-shadow-style img-responsive" src="http://creativedzine.co.in/bwt/public/assets/img/Galley7.jpg" style="max-height:199px;min-height: 199px;">
                </a>
             </div>
             <div class="col-xl-4 col-xs-12">
                <a href="http://creativedzine.co.in/bwt/stores">
                <br>
          ...
          <div class="row bg5">
             <div class="col-xl-4 col-xs-12">
                 <a href="http://creativedzine.co.in/bwt/trailers">
                <br>
                <h4 class="slider_head pad0">Trailers</h4>
                <span class="line-1 mr-l0"></span>
                <span class="line-2 mr-l0"></span>
                <br>
                <video id="video1" controls="" poster="http://creativedzine.co.in/bwt/public/assets/img/image.png" style="max-height:199px;min-height: 199px;">
                        <source src="http://creativedzine.co.in/bwt/public/assets/img/FullSizeRender.MOV" type="video/mp4">
                        <!--<source src="movie.ogg" type="video/ogg">-->
                    </video>
                </a>
             </div>
             ...
             <div class="col-xl-4 col-xs-12">
                 <a href="http://creativedzine.co.in/bwt/my-gallery">
                <br>
                <h4 class="slider_head pad0">Gallery</h4>
                <span class="line-1 mr-l0"></span>
                <span class="line-2 mr-l0"></span>
                <br>
                <img class="bold-text box-shadow-style img-responsive" src="http://creativedzine.co.in/bwt/public/assets/img/gallery11.jpg" style="max-height:199px;min-height: 199px;">
                </a>
             </div>
             <div class="col-xl-4 col-xs-12">
                 <a href="http://creativedzine.co.in/bwt/our-community">
                <br>
    ...
    function saveChannel(channelName){
        ...
        window.location.replace("http://localhost/laravel_new/git/sign-in");
